...
\begin{proc}{evolucionDePosicion}{\In t: $toroide$, \In posicion: $\ent \times \ent$, \Out result: $\bool$}{}
    ...
    \post{result = \True \Iff valorLuegoDeEvolucion(t, posicion)} % estaViva y tiene 2 o 3 adyacentes o ¬estaViva y tiene 3 adyacentes
...
% ===================
% === Ejercicio 4 ===
    \pred{valorLuegoDeEvolucion}{t: $toroide$, pos: $\ent \times \ent$}{
...
% === Ejercicio 6 ===
    ...
    \pred{esEvolucionMultiple}{t: $toroide$, te: $toroide$, k: \ent}{
        (\exists ts: \TLista{toroide})((length(ts) = k)(\forall i: \ent)((0 < i < k)\implicaLuego(esEvolucion(ts[i - 1], ts[i])))\yLuego te = ts[k - 1])
    }
